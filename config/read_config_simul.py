...
print(int(inputs[19]) + int(inputs[20]) + int(inputs[21]), int(inputs[2]))	
assert int(inputs[19]) + int(inputs[20]) + int(inputs[21]) ==  int(inputs[2])
...
file.write("nmeg="+inputs[20]+"\n")
file.write("npeg="+inputs[21]+"\n")
