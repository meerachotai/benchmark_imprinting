...
file.write("index_picard="+inputs[20]+"\n")

file.write("counts_dir_wyder="+inputs[21]+"\n")
file.write("pval_wyder="+inputs[22]+"\n")
file.write("logfc_wyder="+inputs[23]+"\n")

file.write("refA="+inputs[24]+"\n")
file.write("annotA="+inputs[25]+"\n")
file.write("refB="+inputs[26]+"\n")
file.write("annotB="+inputs[27]+"\n")
file.write("gene_key="+inputs[28]+"\n")
file.write("htseq_i="+inputs[29]+"\n")
file.write("pval_anderson="+inputs[30]+"\n")
file.write("mat_cutoff_anderson="+inputs[31]+"\n")
file.write("pat_cutoff_anderson="+inputs[32]+"\n")
file.write("logfc_anderson="+inputs[33]+"\n")
file.write("rep="+inputs[34]+"\n")
file.write("rename="+inputs[35]+"\n")
file.write("a_annot="+inputs[36]+"\n")
file.write("b_annot="+inputs[37]+"\n")
file.write("index_anderson="+inputs[38]+"\n")

file.write("counts_dir_roth="+inputs[39]+"\n")
file.write("pval_roth="+inputs[40]+"\n")
file.write("mat_cutoff_roth="+inputs[41]+"\n")
file.write("pat_cutoff_roth="+inputs[42]+"\n")
