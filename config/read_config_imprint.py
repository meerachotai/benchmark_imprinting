...
file.write("pval_picard="+inputs[13]+"\n")
file.write("paired="+inputs[14]+"\n")
file.write("rep="+inputs[15]+"\n")
file.write("AxB_rep="+inputs[16]+"\n")
...
file.write("refA="+inputs[22]+"\n")
file.write("annotA="+inputs[23]+"\n")
file.write("refB="+inputs[24]+"\n")
file.write("annotB="+inputs[25]+"\n")
file.write("gene_key="+inputs[26]+"\n")
file.write("htseq_i="+inputs[27]+"\n")
file.write("pval_anderson="+inputs[28]+"\n")
file.write("mat_cutoff_anderson="+inputs[29]+"\n")
file.write("pat_cutoff_anderson="+inputs[30]+"\n")
file.write("logfc_anderson="+inputs[31]+"\n")
file.write("rep="+inputs[32]+"\n")
