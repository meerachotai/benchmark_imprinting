...
if(inputs[4] == ""):
	if(inputs[6] == ""):
		...
		config = pd.read_table(inputs[6],delimiter = "\t", header=None)
...
file.write("picard="+inputs[7]+"\n")
file.write("genome="+inputs[8]+"\n")
file.write("annot="+inputs[9]+"\n")
file.write("snps="+inputs[10]+"\n")
file.write("mat_cutoff_picard="+inputs[11]+"\n")
file.write("pat_cutoff_picard="+inputs[12]+"\n")
file.write("paired="+inputs[13]+"\n")
file.write("rep="+inputs[14]+"\n")
file.write("AxB_rep="+inputs[15]+"\n")
file.write("BxA_rep="+inputs[16]+"\n")
file.write("majority="+inputs[17]+"\n")

file.write("counts_dir="+inputs[18]+"\n")
file.write("pval_wyder="+inputs[19]+"\n")
file.write("logfc_wyder="+inputs[20]+"\n")

file.write("refA="+inputs[21]+"\n")
file.write("annotA="+inputs[22]+"\n")
file.write("refB="+inputs[23]+"\n")
file.write("annotB="+inputs[24]+"\n")
file.write("gene_key="+inputs[25]+"\n")
file.write("htseq_i="+inputs[26]+"\n")
file.write("pval="+inputs[27]+"\n")
file.write("mat_cutoff_anderson="+inputs[28]+"\n")
file.write("pat_cutoff_anderson="+inputs[29]+"\n")
file.write("logfc="+inputs[30]+"\n")
file.write("rep="+inputs[31]+"\n")
file.write("rename="+inputs[32]+"\n")
file.write("a_annot="+inputs[33]+"\n")
file.write("b_annot="+inputs[34]+"\n")
